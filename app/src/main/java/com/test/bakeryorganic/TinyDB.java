...
public class TinyDB {
    ...
    public ArrayList<Preferences> getListPreferences(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Preferences> objects = new ArrayList<Preferences>();

        for (String jObjString : objStrings) {
            Preferences value = gson.fromJson(jObjString, Preferences.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListPreferences(String key, ArrayList<Preferences> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
